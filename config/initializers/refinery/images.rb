...
Refinery::Images.configure do |config|
  ...
  # config.dragonfly_secret = "d7004d50edbfefecba6aba0f585eb63e6016a46d15f6d05c"
  config.dragonfly_url_format = "/system/images/:job/:basename.:format"
  config.dragonfly_url_host = "/cms"
  # config.datastore_root_path = "/home/sid/sites/testing/mbanumbers/public/system/refinery/images"
